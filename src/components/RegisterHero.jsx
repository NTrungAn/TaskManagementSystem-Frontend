...
const RegisterHero = () => {
  return (
    <div className="flex flex-col lg:flex-row w-full min-h-screen max-w-[1380px] mx-auto bg-white font-sans overflow-hidden">
      
      {/* Left Column: Branding / Marketing text */}
      <div className="flex-1 flex flex-col justify-center p-10 lg:p-16">
        <div className="flex items-center space-x-3 mb-6">
          <div className="w-[60px] h-[60px] rounded-[20px] bg-[#0B00A7]/40 flex items-center justify-center text-[#0B00A7]">
        ...
        <div className="flex space-x-6 items-end">
           ...
           <div className="flex flex-col mb-4">
             <span className="text-[16px] font-normal leading-snug text-black mb-3 italic">TRUSTED BY <br/> MODERN <br/> TEAMS</span>
      ...
      <div className="w-full lg:w-[525px] flex flex-col justify-center items-center p-8 bg-transparent">
        {/* Form Container */}
        <div className="w-full p-[20px] lg:p-[40px]">
          <h2 className="text-[28px] font-bold text-black mb-10">Đăng ký</h2>
          
          <form className="flex flex-col space-y-6">
            <div className="flex flex-col space-y-2">
              <label className="text-[24px] font-bold text-black flex items-center">
                Họ tên <span className="text-[#D50205] ml-1">*</span>
              </label>
              <div className="relative">
                <input 
                  type="text" 
                  placeholder="Nguoidung123"
                  className="w-[374px] h-[54px] border border-black rounded-sm px-4 text-[24px] font-bold text-black/50 focus:outline-none focus:ring-2 focus:ring-blue-500" 
                />
                <button type="button" className="absolute right-4 top-1/2 transform -translate-y-1/2">
                   {/* User Icon */}
                   <svg width="23" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-black">
            ...
            <div className="flex flex-col space-y-2">
              <label className="text-[24px] font-bold text-black flex items-center">
                Email <span className="text-[#D50205] ml-1">*</span>
              </label>
              <div className="relative">
                <input 
                  type="email" 
                ...
                <button type="button" className="absolute right-4 top-1/2 transform -translate-y-1/2">
                   {/* Email Icon */}
                   <svg width="28" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-black">
            ...
            <div className="flex flex-col space-y-2">
              <label className="text-[24px] font-bold text-black flex items-center">
                Mật khẩu <span className="text-[#D50205] ml-1">*</span>
              </label>
              <div className="relative">
                <input 
                  type="password" 
            ...
            <div className="flex items-start pt-2 w-[374px]">
              <label className="flex items-start space-x-3 cursor-pointer">
                <input type="checkbox" className="w-[15px] h-[15px] mt-2 border border-black rounded-none outline-none flex-shrink-0" />
                <span className="text-[24px] font-bold text-black/90 leading-tight">Tôi chấp nhận điều khoản dịch vụ của hệ thống</span>
              </label>
            </div>

            <button type="button" className="w-[374px] h-[54px] bg-[#0088FF] text-[#FEFCFC] text-[27px] font-semibold flex items-center justify-center mt-6">
              Đăng ký
            </button>
          </form>

          <div className="mt-8 flex flex-col items-start w-[374px]">
            <span className="text-[24px] font-semibold text-black/60 mb-4">Hoặc tiếp tục với:</span>
            ...
            <div className="flex justify-between w-full mt-6">
               <span className="text-[24px] font-semibold text-black hover:text-blue-600 transition-colors cursor-pointer text-center w-full">Bạn đã có tài khoản? Đăng nhập</span>
            </div>
          </div>
        </div>
      </div>
